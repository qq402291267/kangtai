...
- (void)initVariable
{
    ...
    iconArr = [NSMutableArray arrayWithObjects: @"113.png", @"114.png", @"115.png", @"116.png", @"117.png", @"118.png", @"119.png", @"120.png", @"add_mark_normal.png", nil];
...
//    nameTF.textColor = RGB(0, 160, 230);
    nameTF.textColor = RGBA(84.0, 199.0, 20.0, 1);
    if (self.typeNumber == 1) {
...
//    [typeBtn setTitleColor:RGB(0, 160, 230) forState:UIControlStateNormal];
    ...
    [typeBtn setTitleColor: RGBA(84.0, 199.0, 20.0, 1) forState:UIControlStateNormal];
    ...
    [nearestBtn setTitleColor: RGBA(84.0, 199.0, 20.0, 1) forState:UIControlStateNormal];
