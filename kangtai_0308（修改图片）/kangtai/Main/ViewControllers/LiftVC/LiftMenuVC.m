...
- (void)viewDidLoad
{
    ...
    [changePWDBtn setBackgroundImage:[UIImage imageNamed:@"change_password_normal.png"] forState:UIControlStateNormal];
    [changePWDBtn setBackgroundImage:[UIImage imageNamed:@"change_password_click.png"] forState:UIControlStateHighlighted];
