...
- (void)initUI
{
    ...
    indicator.backgroundColor = RGBA(84.0, 199.0, 20.0, 1);
    indicator.tag = 100;
    ...
    for (int i = 0; i < 4; i++) {
        ...
        if (i == 0) {
            ...
            [chooseBtn setTitleColor:RGBA(84.0, 199.0, 20.0, 1) forState:UIControlStateNormal];
        } else {
    ...
    for (int i = 1; i < 3; i++) {
        ...
        consumeValueLabel.textColor = RGBA(84.0, 199.0, 20.0, 1);
        ...
        costValueLabel.textColor = RGBA(84.0, 199.0, 20.0, 1);
...
{
    printf("updateRealtimeDataEveryFiveSeconds\n");
...
- (void)showRealtimeEnergyDataView
{
    ...
    energyLabel.textColor = RGBA(84.0, 199.0, 20.0, 1);
    ...
    iValueLabel.textColor = RGBA(84.0, 199.0, 20.0, 1);
    ...
    voltageValueLabel.textColor = RGBA(84.0, 199.0, 20.0, 1);
...
- (void)updateRealtimeData
{
    ...
    if (wattArr.count != 0) {
        ...
        HJFLog(@"数量=--------------------------------%lu",(unsigned long)wattArr.count);
        HJFLog(@"vStr=--------------------------------%@",vStr);
...
#pragma mark- 曲线图颜色
    ...
    plot1.heightLineColor = RGBA(84.0, 199.0, 20.0, 1);
    ...
    line.backgroundColor = RGBA(84.0, 199.0, 20.0, .65f);
    ...
    unitLabel.textColor = RGBA(84.0, 199.0, 20.0, 1);
    ...
    for (int i=0; i<vArr.count - 1; i++) {
        ...
        [label setTextColor:RGBA(84.0, 199.0, 20.0, 1)];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (scrollView == kindScrollView) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == current) {
                [indicator setFrame:CGRectMake(btn.frame.origin.x, barViewHeight + height - 3, btn.frame.size.width, 3)];
                [btn setTitleColor:RGBA(84.0, 199.0, 20.0, 1) forState:UIControlStateNormal];
            } else {
