...
- (void)viewDidLoad
{
    ...
    self.dataDAY = [[NSMutableArray alloc] initWithObjects:@"100.png",@"111.png",@"112.png",@"113.png",@"114.png",@"115.png",@"116.png",@"117.png",@"118.png",@"119.png",@"120.png",@"111.png", @"112.png",@"add_mark_normal.png",nil];
...
- (void)lodUI
{
    ...
    self.pwdText.textColor = RGBA(84.0, 199.0, 20.0, 1);
