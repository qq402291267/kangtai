...
//customize for convinence
@interface GTMHTTPFetcher (GTMHTTPFetcherNVM)
...
- (void)setValue:(NSString *)value forHTTPHeaderField:(NSString *)field
{
    [request_ setValue:value forHTTPHeaderField:field];
}
...
- (void)setAllHTTPHeaderFields:(NSDictionary *)headerFields
{
    [request_ setAllHTTPHeaderFields:headerFields];
}
...
- (void)setTimeoutInterval:(NSTimeInterval)seconds
{
    [request_ setTimeoutInterval:seconds];
}
